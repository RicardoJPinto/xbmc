...
void CVideoImportRepository::removeSource(const CMediaImportSource &source, CGUIDialogProgress *progress /* = NULL */)
{
...
void CVideoImportRepository::removeImport(const CMediaImport &import, CGUIDialogProgress *progress /* = NULL */)
{
