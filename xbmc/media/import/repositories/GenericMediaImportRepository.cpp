...
bool CGenericMediaImportRepository::RemoveImport(const CMediaImport &import, CGUIDialogProgress *progress /* = NULL */)
{
  if (!m_loaded ||
...
bool CGenericMediaImportRepository::RemoveSource(const std::string &identifier, CGUIDialogProgress *progress /* = NULL */)
{
  if (!m_loaded ||
      identifier.empty())
    return false;
