...
CUPnP::StartClient()
{
    ...
    */
    ...
    COhUPnP::Get().StartContentDirectoryClient();
}
...
CUPnP::StopClient()
{
    ...
    */
    ...
    COhUPnP::Get().StopContentDirectoryClient();
}
...
CUPnP::IsClientStarted()
{
  return COhUPnP::Get().IsContentDirectoryClientRunning();
}
