...
SET python_generated_dir=generated
...
java.exe -cp "%groovy_dir%\groovy-all-1.8.4.jar;%groovy_dir%\commons-lang-2.6.jar;%generator_dir%;." groovy.ui.GroovyMain "%generator_dir%\Generator.groovy" "%python_generated_dir%\%2.xml" PythonSwig.cpp.template "%python_generated_dir%\%2.cpp" "%doxygen_dir%"
